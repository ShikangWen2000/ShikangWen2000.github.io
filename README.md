# Shikang Wen — academic website

Personal academic website built with Jekyll and hosted by GitHub Pages.
...
- `_sass/` and `assets/`: theme styles, scripts, and fonts.
- `images/`, `files/`, and `CV/`: published static assets.
